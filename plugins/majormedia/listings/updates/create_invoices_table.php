...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('majormedia_listings_invoices', function (Blueprint $table) {
            $table->id();
            $table->string('invoice_number')->unique();
            $table->unsignedBigInteger('listing_id')->index('fk_listing_id');
            $table->foreign('listing_id', 'fk_invoices_listing_id')->references('id')->on('majormedia_listings_listings')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('majormedia_listings_invoices');
    }
};
