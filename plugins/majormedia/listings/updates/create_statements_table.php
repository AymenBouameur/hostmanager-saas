...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('majormedia_listings_statements', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('listing_id')->index('fk_listing_id');
            $table->timestamp('statement_date')->nullable()->index('index_statement_date');
            $table->foreign('listing_id', 'fk_statements_listing_id')->references('id')->on('majormedia_listings_listings')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('majormedia_listings_statements');
    }
};
