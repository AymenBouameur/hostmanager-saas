...
class BuilderTableCreateMajorMediaToolBoxNewsletters extends Migration
{
    public function up()
    {
        Schema::create('majormedia_toolbox_newsletters', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    public function down()
    {
      \DB::statement('SET FOREIGN_KEY_CHECKS = 0');
        Schema::dropIfExists('majormedia_toolbox_newsletters');
